...
OLLAMA_OPENAI_URL = "http://192.168.0.119:11434/v1"
EMBED_MODEL_NAME = "nomic-embed-text"
LLM_MODEL_NAME = "qwen3:14b"
LLM_MODEL_NAME_0 = "deepseek-r1:14b"
LLM_TIMEOUT = 200.0
...
vectorstore = Chroma.from_documents(
    ...
    embedding=embed_model_ollama #OpenAIEmbeddings(),  # 使用OpenAI的text-embedding-ada-002模型
)
...
llm = llm_ollama #ChatOpenAI(model="gpt-4o", temperature=0.5)
...
llm = llm_ollama0 #ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0)
...
'''
(venv-rag-langchain) thbytwo@thbytwopower:~/testGit/rag-in-action$ /home/thbytwo/miniforge3/envs/venv-rag-langchain/bin/python /home/thbytwo/testGit/rag-in-action/07-检索后处理-PostRetrieval/03-校正/01-CRAG-反思式检索_ollama.py
USER_AGENT environment variable not set, consider setting it to identify your requests.
/home/thbytwo/testGit/rag-in-action/07-检索后处理-PostRetrieval/03-校正/01-CRAG-反思式检索_ollama.py:38: LangChainDeprecationWarning: The class `OllamaEmbeddings` was deprecated in LangChain 0.3.1 and will be removed in 1.0.0. An updated version of the class exists in the :class:`~langchain-ollama package and should be used instead. To use it run `pip install -U :class:`~langchain-ollama` and import as `from :class:`~langchain_ollama import OllamaEmbeddings``.
  embed_model_ollama = OllamaEmbeddings(
...
/home/thbytwo/miniforge3/envs/venv-rag-langchain/lib/python3.10/site-packages/langchain_openai/chat_models/base.py:1362: UserWarning: Received a Pydantic BaseModel V1 schema. This is not supported by method="json_schema". Please use method="function_calling" or specify schema via JSON Schema or Pydantic V2 BaseModel. Overriding to method="function_calling".
  warnings.warn(
/home/thbytwo/testGit/rag-in-action/07-检索后处理-PostRetrieval/03-校正/01-CRAG-反思式检索_ollama.py:139: LangChainDeprecationWarning: The method `BaseRetriever.get_relevant_documents` was deprecated in langchain-core 0.1.46 and will be removed in 1.0. Use :meth:`~invoke` instead.
  docs = retriever.get_relevant_documents(question)  # 检索相关文档
binary_score='yes'
/home/thbytwo/miniforge3/envs/venv-rag-langchain/lib/python3.10/site-packages/langsmith/client.py:253: LangSmithMissingAPIKeyWarning: API key must be provided when using hosted LangSmith API
  warnings.warn(
Agent memory includes short-term memory, which uses in-context learning for immediate tasks, and long-term memory, stored externally via vector databases for retaining information over time. Long-term memory enables infinite recall through fast retrieval, while short-term memory is limited by the model's context window. Memory systems help agents improve decision-making by learning from past experiences and accessing stored knowledge.
=== CRAG 工作流执行过程 ===
---检索---
"节点 'retrieve':"
'\n---\n'
...
'\n---\n'
=== 最终生成结果 ===
('The types of agent memory include short-term memory, which utilizes '
 'in-context learning for immediate tasks, and long-term memory, which retains '
 'information over extended periods using external vector stores. Short-term '
 'memory aids in processing current interactions, while long-term memory '
 'enables the agent to recall past experiences and data. These memory types '
 "enhance the agent's ability to handle complex tasks and improve over time.")
'''